...
//This code snippet aggregates hourly data to monthly, then for each datapoint, calculated growing degree day as per corresponding sowing and harvest dates.
